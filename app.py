...
if submitted:
    if name and contact and question:
        ...
        st.write("สาส์นสั้นๆ นี้อาจยังไม่พอที่จะเยียวยาทุกอย่าง... แต่อุ้มอยากให้คุณรู้ว่าคุณไม่ต้องแบกความทุกข์นี้ไว้เพียงลำพังนะคะ หากต้องการคำชี้แนะที่เจาะลึกและเป็นคำตอบสำหรับคุณโดยเฉพาะ ทักมาพูดคุยกับอุ้มได้โดยตรงเลยค่ะ ✨")
        
        st.link_button("👉 คุยกับที่ปรึกษา LUMINA SOUL", "https://lin.ee/jmI4z6G")
    else:
        st.error("⚠️ กรุณากรอกข้อมูลให้ครบถ้วน เพื่อการวิเคราะห์ที่แม่นยำค่ะ")
